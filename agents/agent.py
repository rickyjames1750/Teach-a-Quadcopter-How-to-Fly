...
class Actor:
    ...
    def build_model(self):
        ...
        # Add final output layer with sigmoid activation # *** ADDED activation = 'tanh' as suggested in the original paper
...
class DDPG():
    ...
    def __init__(self, task):
        ...
        self.tau = 0.001  # 0.01 for soft update of target parameters ** MODIFIED ACCORDING TO THE ORIGINAL DDPG PAPER
